...
% Unfortunately, we use the free version of overleaf and we can't see the history prior to 24 hours. 
% Therefore, even if you want to contribute and make changes, please keep the existing files.
% Create a copy folder in your own workspace, and work on that copy for changes.
% Then please send a pull request through github: https://github.com/volkanozsarac/Thesis-Template-Latex
